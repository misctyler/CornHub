...
// *****************TESTNET******************
// polygon testnet kernel CORN token contract;
// 0x82B2F4c3F01798692a34fF72282545e1E7F8132c
// polygon testnet popcorn POPCORN token contract;
// 0xC57DBf5b81a0E86fE12F853455E399F960371428
// polygon testnet butter BUTTER token contract;
// 0x0848a06f18da9efcaceb0c4b0de8144f930bdbb9
// polygon testnet NFT minter contract address;
// 
// ********************************************
...
contract cornHubFunHouse is Ownable {
    address cornKernel = 0x82B2F4c3F01798692a34fF72282545e1E7F8132c;
    address popCorn = 0xC57DBf5b81a0E86fE12F853455E399F960371428;
    address butter = 0x0848a06f18da9efcaceb0c4b0de8144f930bdbb9;
    address minterAddr; // contract address for NFT minting 
  ...
  function butterAirdrop() internal returns (uint256) {
    uint256 _prepayout = ERC20Interface(butter).balanceOf(this)/(100000);
  ...
  function setMinterAddr(address _minter) public onlyOwner {
    minterAddr = _minter;
  }
